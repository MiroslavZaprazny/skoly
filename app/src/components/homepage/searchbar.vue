<template>
    <div class="bg-gray-50 text-center py-14">
        ...
        <div class="mt-20">
          <input class="border-2 border-purple-primary focus:outline-none text-purple-primary focus:border-purple-500 focus:ring-border-pink-500 focus:ring-1 rounded-lg p-2 w-1/4" type="text" placeholder="FEI STU" v-model="search" v-debounce:300="searchUpdate" debounce-evets="['click', 'keyup']">
        </div>
    </div>
</template>
